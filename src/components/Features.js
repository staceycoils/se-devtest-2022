...
export default function Features() {
  return (
      <div class='text-center w-full 
          ...
          <h3 class="text-5xl md:text-7xl mx-auto py-8 col-span-2">FEATURES</h3>
          <p class="mx-auto w-[330px] pb-8 
              md:mx-auto md:w-[500px] md:text-2xl md:pb-20 lg:w-[600px] xl:w-[800px] col-span-2">
          ...
          <ul class='text-left mx-auto w-[266px]
              md:mx-auto lg:mt-24 lg:w-[400px] lg:px-16 lg:ml-48'>
