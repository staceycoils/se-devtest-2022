...
export default function Contents() {
  return (
    <div class='text-center w-full mt-24 px-16 
      ...
      <h3 class="text-5xl py-4 md:text-6xl md:col-span-2">Contents</h3>
      ...
      <section class='bg-white text-black my-6 px-4 py-8 rounded-xl 
          md:mx-4 md:mt-16 md:ml-auto md:w-80 lg:w-[480px]' >
        ...
        <button class="bg-custom-lilac w-1/2 h-12 my-12 font-bold text-white md:mt-20">Sign Up</button>
        <p>
          <img src={ require('./Vectors/Macbook_Pro.png') } alt='macbook pro' class='mx-auto'/>
        </p>
      </section>
      <section class='bg-white text-black my-6 px-4 py-8 rounded-xl 
          md:mx-4 md:mt-16 md:mr-auto md:w-80 lg:w-[480px]'>
