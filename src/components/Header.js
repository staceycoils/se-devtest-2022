...
export default function Header() {
  return (
    <div class="text-center grid grid-rows-10 w-full md:mt-20">
      <h3 class="text-3xl px-28 py-4
          md:text-7xl md:w-[900px] md:mx-auto md:font-medium">Work at the speed of thought.</h3>
      ...
      <section class="relative">
        ...
        <img src={images.dashboard} alt='dashboard' 
          class='relative w-[184px] left-1/4 top-16 skew-x-[15deg] -rotate-[37deg]
              md:w-[465px] md:mx-auto md:left-0' />
        <img src={images.chatbot} alt='chatbot' 
          class='relative w-[176px] left-[60.5%] top-.5 -skew-x-[16deg] rotate-[37deg]
              md:w-[446px] md:left-[58%] md:-top-[90px]' />
        <img src={images.boards} alt='boards' 
          class='relative w-[184px] -left-[10%] top-[-162px] -skew-x-[16deg] rotate-[38deg]
              md:w-[466px] md:left-[17%] md:-top-[510px]' />
      </section>
    </div>
  )
}
