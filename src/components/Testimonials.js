...
export default function Testimonials() {
  return (
    <div id='testimonials' class='text-center w-full my-40 px-16
      ...
      <span id='webTestimonialsLeft' class='hidden 
          md:inline md:w-[430px] md:justify-self-end'>
      ...
      <span id='webTestimonialsLRight' class='hidden md:inline md:w-[430px] md:justify-self-start'>
        <section class='border border-gray-500 w-[430px] rounded-xl my-6 p-8 flex flex-wrap md:my-0 
            md:mx-auto md:mb-6' >
